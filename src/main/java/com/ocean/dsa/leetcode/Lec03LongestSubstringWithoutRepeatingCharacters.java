...
public class Lec03LongestSubstringWithoutRepeatingCharacters {
    ...
    public static void main(String[] args) {
        Lec03LongestSubstringWithoutRepeatingCharacters obj = new Lec03LongestSubstringWithoutRepeatingCharacters();
